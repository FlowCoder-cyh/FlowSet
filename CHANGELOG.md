...
### 주요 파일 변경
- 갱신: `rules/wi-global.md`, `templates/.claude/agents/evaluator.md`, `templates/.claude/agents/lead-workflow.md`, `templates/.flowset/fix_plan.md`, `templates/.flowsetrc`, `templates/.flowset/PROMPT.md`, `templates/.flowset/hooks/pre-push`
