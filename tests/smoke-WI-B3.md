...
| WI-B3-2 | review-rubric.md 5축 채점표 (파일 / 5축 키워드 / 축별 섹션 / 가중치 100% / 통과기준 7.5 / 증적 2종 / 익명금지 / 후속 WI) | 8 |
...
- **CI SSOT**: test-vault 31 + A1 14 + A2a-e 81 (13+13+15+16+24) + A3 17 + 001 40 + B1 27 + B2 36 + **B3 29** = **275 assertion** (A4는 CI 미호출, 순수 meta-smoke)
- **로컬 regression (A4 포함)**: 275 + 21 = **296 assertion**
