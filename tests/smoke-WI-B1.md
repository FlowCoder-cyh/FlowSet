...
- **CI SSOT**: test-vault 31 + A1 14 + A2a-e 81 (13+13+15+16+24) + A3 17 + 001 40 + **B1 27** = **210 assertion** (A4는 CI 미호출, 순수 meta-smoke)
- **로컬 regression (A4 포함)**: 204 + 27 = **231 assertion**
- **bats core.bats**: 16 @test (class 무관)

WI-001은 WI-B1에서 41→40 재캘리브레이션 (validation per-class 2건 → combined 1건으로 통합, 원자성 유지).
