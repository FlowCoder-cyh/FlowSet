...
2. **`tests/run-smoke-WI-C5.sh`** 신규 (42 assertion, 7 블록)
3. **`.github/workflows/flowset-ci.yml`** smoke job: 383 → 425 assertion
...
- **CI SSOT**: test-vault 31 + A1 14 + A2a-e 81 (13+13+15+16+24) + A3 17 + 001 40 + B1 27 + B2 36 + B3 35 + C1 60 + C2 42 + **C5 42** = **425 assertion**
- **로컬 regression (A4 포함)**: 425 + 21 = **446 assertion**
